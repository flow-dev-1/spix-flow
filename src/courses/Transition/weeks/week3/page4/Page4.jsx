...
function WeekThreePage4() {
  ...
  for (let i = 0; i < pageData.images.length; i++) {
    ...
    imageMap[
      image
    ] = getAssetUrl(`drag-images/transition-drag-images/week3/image${i + 1}.png`);
  }
  ...
  return (
    <DragDropContext key={dndResetKey} onDragEnd={handleOnDragEnd}>
          ...
          <div className="bg-blue w-lg-50">
            <div className="d-flex align-items-start mb-2">
              ...
              <div className="text-center text-white pt-2">
                <h1 className="transition-week3-drag-instruction">
                  {pageData.instruction}
                </h1>
              </div>
              <img src={ArrowTrail} alt="arrow trail" className="arrow-head" />
            </div>
            <div className="transition-week3-buckets-row px-0 py-0 px-md-4 py-md-2">
                ...
                >
                  {(provided, snapshot) => (
                    <div
                      ref={provided.innerRef}
                      {...provided.droppableProps}
                      className={`transition-week3-bucket-drop p-0 p-md-2 ${
                    ...
                    >
                      ...
                      <div className="transition-week3-hidden-placeholder">
                        {provided.placeholder}
                      </div>
                    </div>
                  )}
      ...
      <div className="transition-week3-progress-tools">
        <div className="transition-week3-step-indicators">
          {[...Array(totalSteps)].map((_, index) => (
            <div
              key={index}
              className={`transition-week3-step-dot ${
        ...
        <button
          type="button"
          onClick={handleReset}
          className="transition-week3-reset-button"
        >
