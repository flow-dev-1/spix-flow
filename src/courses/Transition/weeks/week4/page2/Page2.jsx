...
function WeekFourPage2() {
  ...
  return (
    <>
      <QuestionBox className="transition-week4-page2-question-box">
        <div className="d-flex gap-3 align-center-lg-custom flex-column flex-md-row">
          <h2 className="text-blue fs-1">Question: </h2>
          <h2 className="text-gray fs-1 transition-week4-page2-question-text">
            {pageData.question}{" "}
            {pageData.hasImage && (
              <span className="transition-week4-page2-question-term">
                <img src={values} alt="values" className="question-image" />
                <span className="transition-week4-page2-question-mark">?</span>
              </span>
            )}
            {!pageData.hasImage && "?"}
          </h2>
