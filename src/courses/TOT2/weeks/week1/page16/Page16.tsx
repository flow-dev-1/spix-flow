    ...
    <>
      ...
      <TOTFeedbackModal show={showFeedback} onHide={handleCloseFeedback}>
        ...
        <p className="text-blue">
          <span className="fw-bold">Equality </span>means giving everyone the{" "}
          <span className="fw-bold">same resources</span>, while{" "}
          <span className="fw-bold">Equity </span>means giving each learner{" "}
          <span className="fw-bold">what they need to succeed.</span> Inclusive
          classrooms focus on equity.
        </p>
      </TOTFeedbackModal>
    </>
  );
